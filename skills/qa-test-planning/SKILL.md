...
6. **Write i18n/RTL and accessibility checks as scenario-level test steps in plain language** — no standard IDs, no reference to `ono-react-native-dev-plugin`'s `standards/` docs.
